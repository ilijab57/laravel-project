...
<div class="media mt-5 mb-5">
  ...
  <a class="btn btn-success" href="/admin/aprove/{{$topic->id}}" role="button">Aprove</a>
    @endif
  <a class="btn btn-info edit_btn ml-3" href="/admin/edit/{{$topic->id}}" role="button">Edit</a>

<form action="/admin/delete/{{$topic->id}}" method="POST">
@csrf
@method('DELETE')
